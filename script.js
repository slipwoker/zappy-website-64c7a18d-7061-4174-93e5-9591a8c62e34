document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatableElements.length > 0) {
    animatableElements.forEach(function (el, index) {
      ...
      if (!el.style.transitionDelay && el.dataset.animateGroup !== undefined) {
        const siblings = el.parentElement
          ? el.parentElement.querySelectorAll(ANIMATION_SELECTORS.join(', '))
          : [];
        let siblingIndex = 0;
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "LVL Group uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '64c7a18d-7061-4174-93e5-9591a8c62e34',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '64c7a18d-7061-4174-93e5-9591a8c62e34';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '64c7a18d-7061-4174-93e5-9591a8c62e34';
